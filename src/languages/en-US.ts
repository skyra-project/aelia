...
export default class extends Language {
	...
	public language = {
		...
		COMMAND_JOIN_VOICE_DIFFERENT: `${REDCROSS} I am sorry, but I am playing music in another channel, perhaps try later or ask nicely to the people who came first to join them!`,
		COMMAND_JOIN_VOICE_FULL: `${REDCROSS} I cannot join your voice channel, it's full... kick somebody or make room for me!`,
		COMMAND_JOIN_VOICE_NO_CONNECT: `${REDCROSS} I do not have enough permissions to connect to your voice channel. I am missing the **CONNECT** permission.`,
		...
		COMMAND_QUEUE_EMPTY: `The session is over, add some songs to the queue, you can for example do \`Aelia, add Imperial March\`, and... *dumbrolls*!`,
		...
		COMMAND_REMOVE_INDEX_INVALID: `${REDCROSS} Look, I am no expert in maths, but I kinda expected a number equal or bigger than 1...`,
		COMMAND_REMOVE_INDEX_OUT: amount => `${REDCROSS} I tried getting that song for you, but I only have ${amount} ${amount === 1 ? 'song' : 'songs'} in the queue!`,
		...
		COMMAND_RESUME_SUCCESS: `${GREENTICK} Resumed`,
		COMMAND_SKIP_DESCRIPTION: `Skip the current song.`,
		COMMAND_SKIP_PERMISSIONS: `${REDCROSS} You can't execute this command, you must be a dee-jay or a Moderator.`,
		COMMAND_SKIP_VOTES_VOTED: `${REDCROSS} You have already voted to skip this song.`,
